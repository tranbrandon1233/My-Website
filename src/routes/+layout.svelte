...
<div
    class="container relative flex flex-col max-w-[1400px] mx-auto w-full text-sm sm:text-base min-h-screen overflow-x-scroll [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
>
    <div
